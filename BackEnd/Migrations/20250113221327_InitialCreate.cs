    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EenheidID = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    Naam = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_eenheid", x => x.EenheidID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    HoeveelheidID = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    GerechtID = table.Column<int>(type: "INTEGER", nullable: false),
                    IngredientID = table.Column<int>(type: "INTEGER", nullable: false),
                    EenheidID = table.Column<int>(type: "INTEGER", nullable: false),
                    Aantal = table.Column<double>(type: "REAL", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_hoeveelheid", x => x.HoeveelheidID);
                    table.ForeignKey(
                        name: "FK_hoeveelheid_eenheid_EenheidID",
                        column: x => x.EenheidID,
                        principalTable: "eenheid",
                        principalColumn: "EenheidID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_hoeveelheid_gerecht_GerechtID",
                        column: x => x.GerechtID,
                        principalTable: "gerecht",
                        principalColumn: "GerechtID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_hoeveelheid_ingredient_IngredientID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_hoeveelheid_EenheidID",
                table: "hoeveelheid",
                column: "EenheidID");

            migrationBuilder.CreateIndex(
                name: "IX_hoeveelheid_GerechtID",
                table: "hoeveelheid",
                column: "GerechtID");

            migrationBuilder.CreateIndex(
                name: "IX_hoeveelheid_IngredientID",
                table: "hoeveelheid",
                column: "IngredientID");
        }
